...
import example.core.domain.customer.Address;
import example.core.domain.customer.Customer;
import example.core.domain.customer.CustomerRepository;
import example.core.domain.product.*;
